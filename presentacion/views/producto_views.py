...
class ProductoViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        try:
            ...
            return Response({"count": productos.count(), "results": serializer.data})
    ...
    def stock(self, request, pk=None):
        ...
        try:
            ...
            producto = ProductoService.actualizar_stock(pk, int(cantidad), operacion)
            # Usar ProductoStockSerializer que solo tiene campos válidos

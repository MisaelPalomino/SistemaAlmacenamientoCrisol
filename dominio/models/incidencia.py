...
class Incidencia(models.Model):
    ...
    # ========== RESPONSABLES ==========
    responsable = models.CharField(max_length=100, help_text="Persona que reporta la incidencia")
    asignado_a = models.CharField(max_length=100, blank=True, help_text="Persona asignada para resolver")
    ...
    def resolver(self, solucion: str):
        if self.estado not in ['EN_REVISION', 'EN_PROCESO']:
            raise ValueError("Solo se pueden resolver incidencias en proceso o revisión")
